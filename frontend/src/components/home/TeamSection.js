  ...
  return (
    <>
      <div className='columns' style={{ marginBottom: 0 }}>
        <div className='column team-Title styled-theme-background' style={{ height: '250px' }}>
          <div style={{ width: '60%', margin: '0 auto' }}>
            <p style={{ color: 'white', fontSize: '22px', marginBottom: '2px' }}>RISK-FREE INVESTING</p>
            <p style={{ fontSize: '18px', fontWeight: '200'  }}>RentGap is a property investment simulation allowing you to track properties throughout the UK and invest using virtual currency based on live property data. You will be able to learn about property investing and build confidence in a RISK-FREE environment before you are ready to commit to anything serious. </p>
            ...
            <div className="column">
              <div className='columns'>
                <div className='column is-4  team-member'>
                  <img src='https://res.cloudinary.com/dy7eycl8m/image/upload/v1591897673/Property_investor/pngwave_17_hbyemw.png' className='team-image' />
                ...
                <div className='column is-4 team-member'>
                  <img src='https://res.cloudinary.com/dy7eycl8m/image/upload/v1591897673/Property_investor/pngwave_16_fg6zzk.png' className='team-image' />
                ...
                <div className='column is-4  team-member'>
                  <img src='https://res.cloudinary.com/dy7eycl8m/image/upload/v1591897673/Property_investor/pngwave_18_b92ixm.png' className='team-image' />
